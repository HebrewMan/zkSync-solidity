...
export default async function (hre: HardhatRuntimeEnvironment) {
  console.log(`✨ Running deploy script for the TAA contracts`);
  ...
  const baseUri = "ipds://test.taa.io";
  const name = "TAA NFTs"
  const symbol = "TAA721"
  ...
  console.log(`💰 After Before Balance L2: ${afterBeforeBalanceL2}`);
